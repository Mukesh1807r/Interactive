...
<body>
    ...
    <div class="container">
        ...
        <div>
            <img src="sam1.jpeg" class="one">
        </div>
        <div>
            <img src="sam2.jpeg" alt="" class="one">
        </div>
        <div>
            <img src="sam3.jpeg" alt="" class="one">
        </div>
        <div>
            <img src="sam4.jpg" alt="" class="one">
        </div>

        <div>
            <img src="sam5.jpg" alt="" class="one" >
        </div>
        <div>
            <img src="sam6.jpeg" alt="" class="one">
        </div>
        <div>
            <img src="sam7.webp" alt="" class="one">
        </div>
        <div>
            <img src="sam8.jpg" alt="" class="one">
        </div>
    </div>
    <div class="modal">
    ...
    <footer>
        <p>Designed and Developed by <span>Mukesh R</span></p>
    </footer>
...
## OUTPUT:
![alt text](Output-Sam.png)
![alt text](Output-Sam2.png)
![alt text](Output-Sam3.png)
![alt text](Output-Sam4.png)
